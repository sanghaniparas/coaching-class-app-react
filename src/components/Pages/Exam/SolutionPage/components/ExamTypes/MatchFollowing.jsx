...
const MatchFollowing = ({ singleQuestion, languageId }) => {
      ...
      <div
        ...
        <div className="question-slno">Q.{singleQuestion.questionSerialNo}</div>
         <div className="question-ans">
          {ReactHtmlParser(
           `Q.${singleQuestion.questionSerialNo}` +  singleQuestion.langs.filter((el) => el.languageId === languageId)
              .length === 0
...
export default connect(mapStateToProps)(MatchFollowing);
